...
let food = 'mashed potatoes and gravy';
console.log(food);
...
let luckyResult;
  switch (luckyNumber) {
    ...
    case 2:
      ...
      break;
    case 3:
      luckyResult = "Third is the onen with the polka dot dress";
      break;
    default:
...
let result_two = (adventurous === true ? "Adventures are great!" : "How about we stay home?");
